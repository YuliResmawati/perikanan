...
class M_siswa extends MY_Model {
    ...
    {   
        parent::clear_join();
        $this->_fields_toshow = [
            'siswa.id','nama_siswa', 'nama_rombel','tingkatan', 'nama_sekolah', 'jenis_kelamin', 'nisn', 'siswa.status','npsn', 'd.id as detail_rombel_awal_id'
        ];
    ...
    public function get_all_siswa_rombel($rombel_id)
    {   
        parent::clear_join();
        $this->_fields_toshow = [
            'nik','no_kk','nipd','nisn', 'nama_siswa','jenis_kelamin','siswa.status',
        ...
        parent::where(['r.id' => $rombel_id, 'siswa.status' => '1']);
