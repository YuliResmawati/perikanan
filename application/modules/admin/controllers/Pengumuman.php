...
class Pengumuman extends Backend_Controller {
    ...
    public function __construct()
	{
		...
		$this->_init();
		$this->data['uri_mod'] = 'admin/pengumuman';
        $this->id_key = $this->private_key;
        $this->breadcrumbs->push('Content', 'admin/pengumuman');
        $this->load->model([
	...
	{
        $this->data['add_button_link'] = base_url('admin/pengumuman/add');
        $this->data['page_title'] = "Data Pengumuman";
        $this->data['page_description'] = "Halaman Daftar Data Pengumuman.";
        $this->data['card'] = "true";
        $this->data['breadcrumbs'] = $this->breadcrumbs->show();
        $this->data['id_key'] = $this->id_key;
        
		$this->load->view('pengumuman/v_index', $this->data);
    }

    public function add()
    {
        $this->breadcrumbs->push('Tambah', 'admin/pengumuman/add');
        $this->data['page_title'] = "Tambah Data Pengumuman";
        $this->data['page_description'] = "Halaman Tambah Data Pengumuman.";
        $this->data['card'] = "true";
        $this->data['breadcrumbs'] = $this->breadcrumbs->show();
        $this->data['id_key'] = $this->id_key;

        $this->load->view('pengumuman/v_add', $this->data);
    }
    ...
    {        
		...
		if ($id == FALSE) {
			$this->load->view('errors/html/error_bootbox.php', array('message' => 'ID yang tertera tidak terdaftar', 'redirect_link' => base_url('admin/pengumuman')));
        }

        $this->breadcrumbs->push('Edit', 'admin/pengumuman/edit');
        $this->data['page_title'] = "Edit Data Pengumuman";
    ...
    public function AjaxGet($id = NULL)
    {
        ...
        if ($id == FALSE) {
            ...
            $edit_link = 'admin/pengumuman/edit/'; 
            $response = $this->m_content->get_all_content()->where(['kategori_konten_id' => '1'])->datatables();
            ...
            $response->add_column('file', '$1', "dt_btn_file(pengumuman/, berkas, Lihat Pengumuman, Belum Pengumuman)");
            ...
            if ($this->form_validation->run() == TRUE) {    
                if ($id == FALSE) {
                    ...
                    $this->m_content->push_to_data('status', '1')
                        ...
                        ->push_to_data('kategori_konten_id', '1')
                        ->push_to_data('hits', '0');
