<div class="row mt-4">
    <div class="col-12">
        <?= form_open($uri_mod.'/AjaxSaveMateri', 'id="formAjax" class="form"') ?> 
        <input type="hidden" class="mt-token-response" name="mt-token-response">
        <input type="text" class="form-control" name="mapel_id" id="mapel_id" value="<?= encrypt_url($id, $id_key) ?>" readonly>
