    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".button-view", function (e) {
            ...
            if(data!=false){
                ...
                $('#tgl_lahir').val(data.data.tgl_lahir_view);
                ...
                $('#tgl_sk_cpns').val(data.data.tgl_sk_cpns_view);
                $('#sk_pengangkatan').val(data.data.sk_pengangkatan);
                $('#tgl_sk_pengangkatan').val(data.data.tgl_sk_pengangkatan_view);
                ...
                $('#kgb_terakhir').val(data.data.kgb_terakhir_view);
