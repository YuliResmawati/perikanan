<div class="table-responsive mb-4 mt-4">
    <table id="table-ikm" class="table table-striped w-100">
        <thead>
            <tr>
                <th style="text-align: center; vertical-align: middle;">#</th>
                <th style="text-align: center; vertical-align: middle;">Kusioner</th>
    ...
    $(document).ready(function() {
        ...
        datatables = {
            ...
            columns: [
                ...
                {"data": "pertanyaan", searchable:false, orderable:false},
