...
class Panel_harga extends Backend_Controller {
    ...
    {        
        ...
        $this->breadcrumbs->push('Edit', 'bidang/panel_harga/edit');
    ...
    public function AjaxGet($id = NULL)
    {
        ...
        if ($id == FALSE) {
            ...
            $response = $this->m_wilayah->get_all_panel_kecamatan(1)->datatables();
    ...
    public function AjaxGetPanel($add = NULL, $id = NULL)
    {
        ...
        if ($id !== FALSE) {
            if($add == 'list'){
                ...
                $response = $this->m_panel_harga->get_all_komoditas_by_kecamatan()->where(['type' => '1'])->datatables();
