<div class="row mt-4">
    <div class="col-12">
        ...
        <input type="hidden" class="uprp-token-response" name="uprp-token-response">
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        ...
        if (data != false) {
            ...
            $('#jumlah').val(data.data.jumlah_upr);
            $('#lahan').val(data.data.luas_lahan);
    ...
    $('#submit-btn').click(function(e) {
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('<?php echo RECAPTCHA_SITE_KEY; ?>', {action: 'submit'}).then(function(token) {
                document.querySelector('.uprp-token-response').value = token;
                $('#formAjax').submit()
            });
        });
    });
