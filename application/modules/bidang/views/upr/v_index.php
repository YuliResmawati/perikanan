<div class="table-responsive mb-4 mt-4">
    <table id="table-upr" class="table table-striped w-100">
        <thead>
            <tr>
                <th style="text-align: center; vertical-align: middle;">#</th>
                <th style="text-align: center; vertical-align: middle;">Kecamatan</th>
                <th style="text-align: center; vertical-align: middle;">Total UPR(Unit)</th>
                <th style="text-align: center; vertical-align: middle;">Total Luas Lahan(Ha)</th>
    ...
    $(document).ready(function() {
        ...
        datatables = {
            ...
            columns: [
                ...
                {"data": "jumlah", searchable:false, orderable:false, "sClass": "text-center align-middle"},
