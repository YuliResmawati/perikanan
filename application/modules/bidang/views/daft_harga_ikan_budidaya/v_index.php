<div class="table-responsive mb-4 mt-4">
    <table id="table-panel-ikan-budidaya" class="table table-striped w-100">
        <thead>
            <tr>
                <th style="text-align: center; vertical-align: middle;">#</th>
                <th style="text-align: center; vertical-align: middle;">Kecamatan</th>
                <th style="text-align: center; vertical-align: middle;">Total Komoditas</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        table_name = '#table-panel-ikan-budidaya';
        ...
        datatables = {
            ...
            columns: [
                ...
                {"data": "total_panel", searchable:false, orderable:false, "sClass": "text-center align-middle"},
