                ...
                <div class="col-md-4">
                    <article class="charity-item">
                        <figure class="charity-image">
                            ...
                            <div class="btn-wrap">
                                <a href="<?= base_url('berita/') .$row->slug ?>" class="button-round-primary">Lihat</a>
                            </div>
                        </figure>
                        <div class="charity-content">
                            <h3 class="title"><a href="<?= base_url('berita/') .$row->slug ?>" class="max-lines text-justify"><?= xss_escape($row_judul) ?></a></h3>
                            <p class="max-lines-des text-justify"><?= $row_isi?><a href="<?= base_url('berita/') .$row->slug ?>">...Read more</a></p>
