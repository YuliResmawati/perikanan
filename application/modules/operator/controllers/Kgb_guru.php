...
class Kgb_guru extends Backend_Controller {
    ...
    public function __construct()
	{
        ...
        $this->load->model(['m_guru','m_sekolah']);
    ...
    public function index()
	{
        ...
        $this->data['page_title'] = "Data KGB Guru";
    ...
    public function add()
    {
        $this->breadcrumbs->push('Tambah', 'operator/kgb_guru/add');
        $this->data['page_title'] = "Tambah Data KBG Guru";
        $this->data['page_description'] = "Halaman Tambah Data KGB Guru.";
        $this->data['card'] = "true";
        $this->data['breadcrumbs'] = $this->breadcrumbs->show();
