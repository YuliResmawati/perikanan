...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <!-- Vendor CSS Files -->
  <link href="<?= $theme_path ?>/vendor/aos/aos.css" rel="stylesheet">
  <link href="<?= $theme_path ?>/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="<?= $theme_path ?>/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="<?= $theme_path ?>/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="<?= $theme_path ?>/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="<?= $theme_path ?>/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="<?= $theme_path ?>/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
...
<body>
    ...
    <!-- Vendor JS Files -->
  <script src="<?= $theme_path ?>/vendor/aos/aos.js"></script>
  <script src="<?= $theme_path ?>/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?= $theme_path ?>/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="<?= $theme_path ?>/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="<?= $theme_path ?>/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="<?= $theme_path ?>/vendor/waypoints/noframework.waypoints.js"></script>
  <script src="<?= $theme_path ?>/vendor/php-email-form/validate.js"></script>
